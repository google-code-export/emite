...
do
for j in target/emite-0.2.7/com.calclab.emiteui.EmiteUI/ src/main/java/com/calclab/emiteui/public
do
perl -p -i -e "s/(<title>Emite UI application )(.*)(<\/title>)/\$1r$REV+c$COMMITSPENDING \(0.2.7\)\$3/gi" $j/$i
