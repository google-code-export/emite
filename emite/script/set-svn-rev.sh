...
do
for j in target/emite-0.4.2/com.calclab.emiteui.EmiteUI/ src/main/java/com/calclab/emiteui/public
do
perl -p -i -e "s/(<title>Emite UI application )(.*)(<\/title>)/\$1r$REV+c$COMMITSPENDING \(0.4.2\)\$3/gi" $j/$i
