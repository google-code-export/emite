...
public class RoomTest {
    ...
    public void shouldChangeSubject() {
        ...
        emite.verifySent(genSubjectChangeMessage());
    }
    ...
    private String genSubjectChangeMessage() {
        String subjectChange = "<message type=\"groupchat\" from=\"" + userURI + "\" to=\"" + room.getOtherURI()
