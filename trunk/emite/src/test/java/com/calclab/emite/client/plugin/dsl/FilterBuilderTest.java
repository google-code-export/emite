...
public class FilterBuilderTest {
	...
	public void testCreateMatchers() {
		...
		assertWhen(when.MessageTo("recipient"), new Message("recipient",
				"theMessage"));

		assertWhen(when.Packet("stream:features"), new BasicPacket(
				"stream:features", null));
	}

	private void assertWhen(final ActionBuilder actionBuilder,
			final Packet packet) {
