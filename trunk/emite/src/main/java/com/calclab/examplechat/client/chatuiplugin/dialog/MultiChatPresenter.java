...
public class MultiChatPresenter implements MultiChat, GroupChatListener, PairChatListener {
    ...
    public void doAfterLogin() {
        ...
        case online:
        case onlinecustom:
            presenceManager.setOnlinePresence(ownPresence.getStatusText());
            break;
        case busy:
        case busycustom:
        ...
        case offline:
            ...
            presenceManager.setOnlinePresence(null);
            break;
        }
    }
    ...
    public void onStatusSelected(final OwnPresence ownPresence) {
        ...
        case busy:
        case busycustom:
            // FIXME: Dani (Presencia), necesito una forma de ver que estoy
