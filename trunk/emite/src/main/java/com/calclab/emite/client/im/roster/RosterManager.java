...
public class RosterManager extends EmiteComponent {
    ...
    // FIXME: Vicente - no!, cuando necesitas hacer pruebas de algo que no
    // debería
    // ser público se pone default y las pruebas dentro del mismo paquete
    // Dani, revisa: he hecho esto público para poder hacer pruebas del
    // roster... (estoy por quitarlo, pero tengo que ver como hacer mejor mis
    // pruebas)
    // De momento te lo dejo así, pero si te da error es porque no estás
    // planteando bien las pruebas!!!
    // TODO: quitar public a este método
