...
public class Presence extends BasicStanza {
    public static enum Show {
        // Dani: he añadido available que faltaba, espero que no afecte...
        away, chat, dnd, xa, available
    }
    ...
    // ver comentario abajo... devolvería 0
    ...
    // vjrj: pues si alguien con algún cliente pone una prioridad negativa, nos
    // jode...así que yo le prondría la peor prioridad (0) si es negativa
